...
static void animate_luna(void) {
    ...
    #define IDLE_STATE_DURATION 2500

    if (timer_elapsed32(state_timer) > IDLE_STATE_DURATION) {
        state_timer = timer_read32();
        state = (state + 1) % 5;
    }
    ...
    switch (state) {
        case 0: luna_action(sit);   break;
        case 1: luna_action(walk);  break;
        case 2: luna_action(run);   break;
        case 3: luna_action(bark);  break;
        case 4: luna_action(sneak); break;
    }
}
