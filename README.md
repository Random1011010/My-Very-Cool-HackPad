...
| Cherry MX-style switches | 6 | |
| Keycaps | 6 | |
| Rotary encoder (EC11) with push-button | 1 | |
| 128x32 I2C OLED display (SSD1306) | 1 | |
| Custom PCB | 1 | 2-layer, KiCad |
| 3D printed case | 1 | Designed in Fusion 360 |
| M3 heatset inserts | 6 | |
| Diodes | 6 | 1N4148, one per switch |
